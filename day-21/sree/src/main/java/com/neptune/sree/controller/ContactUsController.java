...
import com.neptune.sree.service.ContactUsService;
...
public class ContactUsController {
    ...
    public ResponseEntity<String> deleteArt(@PathVariable Long cid){
    	boolean isDeleted = contactService.deleteArt(cid);
